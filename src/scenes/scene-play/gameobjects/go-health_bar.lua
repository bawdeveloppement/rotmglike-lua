...
function GOHealthBar:draw( characterComponent )
    ...
    self.healthText:set("".. math.floor(characterComponent.stats.life * 10) / 10 .. " / " .. characterComponent.stats.max_life.base + characterComponent.stats.max_life.equipment)
    love.graphics.setColor(255, 0, 0, 255);
    love.graphics.rectangle("fill", w / 2 - 150, h - 68, 300 * ( characterComponent.stats.life / (characterComponent.stats.max_life.base + characterComponent.stats.max_life.equipment) ), 32)
